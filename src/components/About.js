...
function About(){
    ...
    return(
        ...
        <div class="text-black container md:pl-16 md:px-6 flex justify-between">
        <div class="md:w-3/4 ">
            <h1 class="playfair text-5xl pb-4 text-gray-800" >Hi there, I'm Piyush!</h1>
        ...
        <img src={profile} class=" w-40 hidden md:block border-2 border-gray-800 rounded-full h-40" alt=""></img>
    </div>
    <div className='mt-16 md:pl-16 px-6 playfair text-3xl text-gray-800' >
        <h1>My skillset</h1>
    </div>
    ...
    <Link to="/work" className='mt-8 bg-gray-800 text-white p-2 float-right'>
        <h1>Work &#x21E8;</h1>
    </Link>
    </div>
    </motion.div>
