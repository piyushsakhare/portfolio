...
function Contact(){
    ...
    return(
        ...
        <div className='my-24 mx-8 md:mx-1'>
            <h1 className='playfair text-gray-800 text-4xl' >Say Hello !</h1><br>
            </br>
            ...
            <div className='md:flex mt-6' >
                ...
                <br></br><br></br>
                <button className='float-right p-2 bg-gray-800 text-white' type="submit" >Send Message</button>
                </form>
              ...
              <Link className='float-left md:my-10 bg-gray-800 p-2 text-white' to="/work">&#x21E6; Work </Link>
